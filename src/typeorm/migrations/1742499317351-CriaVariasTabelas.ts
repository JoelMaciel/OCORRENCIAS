...
export class CriaVariasTabelas1742499317351 implements MigrationInterface {
    name = 'CriaVariasTabelas1742499317351'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "viaturas" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "prefixo" character varying(20) NOT NULL, "placa" character varying(20) NOT NULL, "modelo" character varying(30) NOT NULL, "unidade_policiamento" character varying(30) NOT NULL, "status" character varying(20) NOT NULL, "ocorrenciaId" uuid, CONSTRAINT "REL_24c704ed7903c8014bd6e04ace" UNIQUE ("ocorrenciaId"), CONSTRAINT "PK_06a82d2210113068cb6e1043ab7" PRIMARY KEY ("id"))`);
